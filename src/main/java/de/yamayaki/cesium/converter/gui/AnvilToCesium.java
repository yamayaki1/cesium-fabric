...
public class AnvilToCesium {
    ...
    private void importPlayerData(final Path basePath) {
        final IPlayerStorage originalStorage = new AnvilPlayerStorage(this.logger, basePath);
        final IPlayerStorage newStorage = new CesiumPlayerStorage(this.logger, basePath);
    ...
    private void importLevel(final LevelStorageSource.LevelStorageAccess levelAccess, final ResourceKey<Level> level) {
        ...
        final IChunkStorage originalStorage = new AnvilChunkStorage(this.logger, dimensionPath);
        final IChunkStorage newStorage = new CesiumChunkStorage(this.logger, dimensionPath);
