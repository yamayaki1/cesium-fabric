package de.yamayaki.cesium.mixin.base.dimension.chunk;
...
public class ChunkStorageMixin implements IStorageSetter<ChunkPos, CompoundTag>, IStorageProvider<ChunkPos, CompoundTag> {
    /* Vanilla imports */
